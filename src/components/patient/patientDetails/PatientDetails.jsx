...
const PatientDetails = () => {
    ...
    const getUserData = async (e) => {
        try {
            ...
            const details = await axios.get(`https://doctors-app-backend-vr89.onrender.com/getuserdetails`, { headers: { 'Authorization': `${token}` } });
    ...
    return (
        <div className='patientdetails'>
            <div className='patientimage'><img className='patientprofileimage' src={`https://doctors-app-backend-vr89.onrender.com/` + patientDetails.profile_image} alt='patient'></img></div>
