...
const PatientDashboard = () => {
  ...
  const getdoctors = async () => {
    try {
      const dataset = await axios.get("https://doctors-app-backend-vr89.onrender.com/getapproveddoctors");
        ...
        doctorDetails.map((item, index) => (
          <div key={index}>
            <div className='itemclass'>
              <img className='patientdashboardimage' src={`https://doctors-app-backend-vr89.onrender.com/` + item.profile_image} alt={item.name}></img>
